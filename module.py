    ...
    try:
        while True:
            ...
            if(dist_left > turn_alert and dist_front > turn_alert - 10 and dist_right > turn_alert):
                ...
                mapping.map[mapping.currLoc[0][0]][mapping.currLoc[0][1]] = 4
                mapping.printMap()
                ...
                BP.set_motor_power(BP.PORT_C+BP.PORT_B,0)
                flag = 0
            elif(dist_front > turn_alert-10): #and if front is not blocked due to IR or magnet sensors
                flag = 0
                pass
            ...
            mapping.prev_encoder = mapping.mapUpdate(mapping.prev_encoder)
            gyro = readGyro()
